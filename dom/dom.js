...
// document.getElementsByClassName("class") -> trả về HTMLCollection [class]
const classNode = document.getElementsByClassName("container");
console.log(classNode);

// document.getElementsByTagName("tagname") -> trả về HTMLCollection [tag]
...
// hasAttribute("attribute") :kiếm tra selector có attribute không, trả về true, false
console.log(d.hasAttribute("class")); // true
console.log(d.hasAttribute("id")); // false
