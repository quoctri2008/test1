...
//substring -> lấy ra các kí tự của chuỗi (start index, end index - 1)
console.log(fullname.substring(1, 5)); // ruon

const Str6 = "   Front End Developer   ";
//bỏ khoảng trống 2 bên, đưa tất cả về in hoa, thay 'Developer' bằng 'Designer', lặp lại 2 lần
console.log(Str6.trim().toUpperCase().replace("Developer", "Designer").repeat(2));