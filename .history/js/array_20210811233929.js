...
// const pets2 = pets.splice(1); // 1 chạy đến end
// console.log(pets); //["cat", "bird", "dragon"]
const pets3 = pets.splice(0, 2); // tại index = 0, xóa 2 phần tử
console.log(pets); // ["bird", "dragon"]
const pets4 = pets.splice(0, 2, "pig"); // tại index = 0, xóa 2 phần tử, thêm pig
console.log(pets); // ["pig, "bird", "dragon"]